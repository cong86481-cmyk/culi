...
async function main() {
  ...
  // Create categories
  const categories = [
    { name: 'Rank Thấp', slug: 'rank-thap' },
    { name: 'Rank Cao', slug: 'rank-cao' },
    { name: 'VVIP Account', slug: 'vvip-account' },
    { name: 'Tài Khoản Mới', slug: 'tai-khoan-moi' },
  ]
  ...
  const accounts = [
    ...
    {
      title: 'Account Vàng - Tài Khoản Giá Rẻ - Đã Nạp Tiền',
      price: 200000,
      rank: 'Vàng',
      vipLevel: 1,
      vipGuns: 1,
      ...
      skins: 5,
      characters: ['Warrior'],
      backpack: ['Pistol Default'],
      description: 'Tài khoản rank Vàng giá rẻ, đã nạp tiền. Phù hợp cho người chơi mới hoặc muốn thử nghiệm.',
      thumbnail: 'https://images.unsplash.com/photo-1538481199705-c710c4e965fc?w=800&h=600&fit=crop',
      images: [],
      username: 'cheapacc01',
      password: 'Cheap123!',
      featured: false,
      categorySlug: 'rank-thap',
    },
    {
      title: 'Account Thách Đấu - VIP 7 Max - Đỉnh Cao',
      price: 5500000,
      rank: 'Thách Đấu',
      vipLevel: 7,
      vipGuns: 15,
      legendaryGuns: 25,
      skins: 80,
      characters: ['Legend', 'Champion', 'Master', 'Grandmaster', 'Top1'],
      backpack: ['All VVIP Weapons', 'All Legendary Weapons', 'Exclusive Skins'],
      description: 'Đỉnh của đỉnh! Account VIP 7 Max rank Thách Đấu với toàn bộ vũ khí VVIP và Huyền Thoại. Đây là tài khoản top 1 server, phù hợp cho dân chơi thực thụ.',
      thumbnail: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&h=600&fit=crop',
      images: [
        'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&h=600&fit=crop',
        'https://images.unsplash.com/photo-1538481199705-c710c4e965fc?w=800&h=600&fit=crop',
      ...
      username: 'toplegend2024',
      password: 'TopLegend123!',
      featured: true,
      categorySlug: 'vvip-account',
    },
    {
      title: 'Account Bạc - Mới Tạo - Giá Cực Rẻ',
      price: 80000,
      rank: 'Bạc',
      vipLevel: 0,
      vipGuns: 0,
      ...
      characters: ['Newbie'],
      backpack: [],
      description: 'Tài khoản mới tạo, rank Bạc, giá cực rẻ. Dành cho người muốn có acc để chơi ngay.',
      thumbnail: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=800&h=600&fit=crop',
      images: [],
      username: 'silvernew',
      password: 'Silver123!',
    ...
    {
      title: 'Tài Khoản Kim Cương - VIP 5 - Bộ Sưu Tập Đẹp',
      price: 2200000,
      rank: 'Kim Cương',
      vipLevel: 5,
      vipGuns: 10,
      legendaryGuns: 18,
      skins: 50,
      characters: ['Phantom', 'Reaper', 'Knight', 'Paladin'],
      backpack: ['AK-47 Dragon', 'AWP Galaxy', 'M4A1 Cyber', 'Desert Eagle Gold'],
      description: 'Account VIP 5 rank Kim Cương với bộ sưu tập vũ khí đẹp nhất. Nhiều skin rare và limited. Lựa chọn hoàn hảo cho game thủ muốn khẳng định đẳng cấp.',
      thumbnail: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&h=600&fit=crop',
      images: [
        'https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&h=600&fit=crop',
        'https://images.unsplash.com/photo-1542751110-97427bbecf20?w=800&h=600&fit=crop',
      ],
      username: 'diamondcollex',
      password: 'Collex2024!',
      featured: true,
      categorySlug: 'vvip-account',
    },
